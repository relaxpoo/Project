...
<div class="wrap">
  ...
  <div class="items">
        <div data-price="290" class="item">
            <img class="first-slide home-image" src="<c:url value="resources/images/Globaldesi.jpg"/> 
                <div class="info">
        ...
        <div data-price="900" class="item">
            <img class="first-slide home-image" src="<c:url value="resources/images/mast.jpg"/>
                <div class="info">
                    <h3>Our Legacy Splash Jacquard Knit</h3>
                    <p class="descroption">Black Grey Plants</p>
                    <h5>$900</h5>
        ...
        <div data-price="600" class="item">
            <img class="first-slide home-image" src="<c:url value="resources/images/kangna.jpg"/>
                <div class="info">
                    <h3>Our Legacy Splash Jacquard Knit</h3>
                    <p class="descroption">Black Grey Plants</p>
                    <h5>$600</h5>
         ...
         <div data-price="457" class="item">
            <img class="first-slide home-image" src="<c:url value="resources/images/kareena.jpg"/>
                <div class="info">
                    <h3>Our Legacy Splash Jacquard Knit</h3>
                    <p class="descroption">Black Grey Plants</p>
                    <h5>$457</h5>
